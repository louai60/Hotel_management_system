...
import OrderDetailsSidebarLinkGroup from './OrderDetailsSideBarLinkGroup';

function OrderDetailsSidebar({ sidebarOpen, setSidebarOpen }) {
            ...
            >
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            {/* Dashboard */}
                            <OrderDetailsSidebarLinkGroup activecondition={pathname === '/' || pathname.includes('dashboard')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
