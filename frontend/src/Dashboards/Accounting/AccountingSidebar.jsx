...
import AccountingSidebarLinkGroup from './AccountingSidebarLinkGroup';
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            ...
                            {/* Community */}
                            <HouseKeepingSidebarLinkGroup activecondition={pathname.includes('community')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
                            ...
                            {/* Finance */}
                            <HouseKeepingSidebarLinkGroup activecondition={pathname.includes('finance')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
                            ...
                            {/* Job Board */}
                            <HouseKeepingSidebarLinkGroup activecondition={pathname.includes('job')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
                            ...
                            {/* Settings */}
                            <HouseKeepingSidebarLinkGroup activecondition={pathname.includes('settings')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
                            ...
                            {/* Utility */}
                            <HouseKeepingSidebarLinkGroup activecondition={pathname.includes('utility')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
