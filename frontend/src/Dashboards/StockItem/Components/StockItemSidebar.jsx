...
import StockItemSidebarLinkGroup from './StockItemSideBarLinkGroup';

function StockItemSidebar({ sidebarOpen, setSidebarOpen }) {
        ...
        <div>
            ...
            >
                ...
                <div className="flex justify-between mb-10 pr-3 sm:px-2">
                    ...
                    {/* Logo */}
                    <NavLink end to="/stockitem" className="block">
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            {/* Dashboard */}
                            <StockItemSidebarLinkGroup activecondition={pathname === '/' || pathname.includes('dashboard')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
...
export default StockItemSidebar;
