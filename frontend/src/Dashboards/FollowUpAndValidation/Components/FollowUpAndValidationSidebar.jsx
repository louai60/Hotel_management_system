...
import FollowUpAndValidationSidebarLinkGroup from './FollowUpAndValidationSideBarLinkGroup';

function FollowUpAndValidationSidebar({ sidebarOpen, setSidebarOpen }) {
            ...
            >
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            {/* Dashboard */}
                            <FollowUpAndValidationSidebarLinkGroup activecondition={pathname === '/' || pathname.includes('dashboard')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                                            FollowUpAndValidation Management
                                                        </span>
                                                    </div>
                                                    {/* Icon */}
                            ...
                            </FollowUpAndValidationSidebarLinkGroup>
...
export default FollowUpAndValidationSidebar;
