...
import HouseKeepingServiceSidebarLinkGroup from './HouseKeepingServiceSideBarLinkGroup';

function HouseKeepingServiceSidebar({ sidebarOpen, setSidebarOpen }) {
            ...
            >
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            {/* Dashboard */}
                            <HouseKeepingServiceSidebarLinkGroup activecondition={pathname === '/' || pathname.includes('dashboard')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
                                                ...
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                                            HouseKeepingService Management
                                                        </span>
                                                    </div>
                                                    {/* Icon */}
                            ...
                            </HouseKeepingServiceSidebarLinkGroup>
...
export default HouseKeepingServiceSidebar;
