...
import OrderManagementSidebarLinkGroup from './OrderManagementSideBarLinkGroup';

function OrderManagementSidebar({ sidebarOpen, setSidebarOpen }) {
            ...
            >
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            {/* Dashboard */}
                            <OrderManagementSidebarLinkGroup activecondition={pathname === '/' || pathname.includes('dashboard')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
                            ...
                            </OrderManagementSidebarLinkGroup>
