...
import CleaningDetailSidebarLinkGroup from './CleaningDetailSideBarLinkGroup';

function CleaningDetailSidebar({ sidebarOpen, setSidebarOpen }) {
            ...
            >
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            {/* Dashboard */}
                            <CleaningDetailSidebarLinkGroup activecondition={pathname === '/' || pathname.includes('dashboard')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
                            ...
                            </CleaningDetailSidebarLinkGroup>
