...
import PaymentSidebarLinkGroup from './PaymentSideBarLinkGroup';

function PaymentSidebar({ sidebarOpen, setSidebarOpen }) {
            ...
            >
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            {/* Dashboard */}
                            <PaymentSidebarLinkGroup activecondition={pathname === '/' || pathname.includes('dashboard')}>
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            <a
