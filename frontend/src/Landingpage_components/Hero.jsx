  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex-3 flex-row justify-between items-center w-full">
          ...
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-black ss:leading-[100.8px] leading-[75px]">
            Welcome back  <br className="sm:block hidden" />{" "}
            <span className=" bg-gradient-to-r from-blue-700 via-black-300 to-black text-transparent bg-clip-text animate-gradient ">To our</span>{" "}
          </h1>
        ...
        <p className={`${styles.paragraph} max-w-[470px] text-2xl font-bold bg-gradient-to-r from-blue-700 via-black-300 to-black text-transparent bg-clip-text animate-gradient`}>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <img src={robot} alt="billing" className="w-[50%] h-[90%] relative z-[0]" />
